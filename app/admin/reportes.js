      ...
      return `
        <tr>
          ...
          <td style="padding:10px;border:1px solid #ddd;vertical-align:top;font-size:12px;">
            ...
            <span style="color:#6b7280;font-size:11px;">${ev.facultad || ''}</span>
          </td>
          <td style="padding:10px;border:1px solid #ddd;vertical-align:top;font-size:12px;">
          ...
          <td style="padding:10px;border:1px solid #ddd;vertical-align:top;font-size:12px;">
            <span style="color:#6b7280;">${ev.horaevento || ''}</span><br>
            <span style="color:#6b7280;font-size:11px;">${ev.participacion_esperada ? ev.participacion_esperada + ' personas' : ''}</span>
          </td>
        </tr>
      `;
    }).join('');
